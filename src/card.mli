(** Representation of cards in the poker game
    ...
    This module represents the remaining cards that have not been
    dealt yet, which includes initializing a new deck of cards, 
    drawing cards randomly from the deck of remaining cards, and 
    showing cards to players by printing them out in a string. It 
    handles comparing hands of players at the end of the game as 
    well as estimating the strength of hands which is an important 
    piece of information to bot *)

(** The abstract type of card. The suits are [S]pades, [H]earts, 
    [C]lubs [D]iamonds.
    Examples:
